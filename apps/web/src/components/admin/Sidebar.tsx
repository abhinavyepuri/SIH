...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-border-light min-h-screen flex flex-col">
      ...
      <div className="px-4 py-4 border-t border-border-light space-y-1">
        <Link href="#" className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-warm-gray hover:text-navy hover:bg-cream transition-all">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button 
          onClick={() => logout()}
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-warm-gray hover:text-navy hover:bg-cream transition-all text-left"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
